<template>
  <div class="main_wrap" id="zuma">
	...
	<audio id="ad"autoplay loop src="/static/media/sweet.mp3"></audio>
  </div>
</template>
...
function init(){
	...
	function game(){
		...
		setInterval(function(){
			...
			oGc.save();
			var line=oGc.createLinearGradient(100,400,400,600);
